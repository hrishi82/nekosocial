            ...
            <i className="fas fa-filter"></i>
              {viewFilterModal && (
                ...
                <p className="filter-modal-text text-left">Sort by:</p>
                  <p className="filter-modal-options" onClick={()=>dispatch(postSortingHandler("LATEST"))}>Latest Posts</p>
                  <p className="filter-modal-options" onClick={()=>dispatch(postSortingHandler("TRENDING"))}>Trending Posts</p>
                  <p className="filter-modal-options" onClick={()=>dispatch(postSortingHandler("OLDEST"))}>Oldest Posts</p>
                  <p className="filter-modal-options clear-filter-btn" onClick={()=>dispatch(postSortingHandler("RESET"))}>Clear Filter</p>
                </div>
              )}
            </div>
